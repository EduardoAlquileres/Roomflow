...
export default function FianzaCuotasPanel({ fianzaId, importeTotal, entregado, cuotas: iniciales }: { fianzaId: string; importeTotal: number; entregado: number; cuotas: CuotaFianza[] }) {
  ...
  if (cuotas.length === 0) return <span className="text-sm text-slate-400">Sin plan de cuotas</span>;
